            ...
            <div class="uk-grid-medium" data-uk-grid="">
                <div class="uk-width-expand@m">
                    <div class="footer-logo">
                        <img class="uk-display-block" src="/img/w-logo.png" alt="footer-logo" width="240" data-uk-img="">
                    </div>

                    <p class="uk-visible@m">35th Floor, 3506<br>
                        Ubora Tower Business Bay<br>
                        Dubai, UAE<br>
                        Email : Support@aonetrades.com<br>
                        Phone No : +97165616276
                    </p>
                </div>
                    ...
                    <div class="uk-child-width-1-3@s uk-child-width-1-3@m" data-uk-grid="">
                        <div>
                            ...
                            <ul class="uk-list uk-link-text">
                                ...
                                <li><a href="{{ route('syntheticIndices') }}">Synthetic indices</a></li>
                                <li><a href="https://www.investing.com/economic-calendar/">Economic Calendar</a></li>
                        ...
                        <div>
                            <h4><span><a href="{{ route('contact') }}"> Contact Our Location</a></span></h4>
                            <ul class="uk-list uk-link-text">
                    ...
                    <div class="uk-grid uk-flex uk-flex-middle" data-uk-grid="">
                        ...
                        <div class="uk-width-1-2@m uk-flex uk-flex-right@m">
                            ...
                            <div class="uk-flex social-media-list">
                                <div><a href="https://www.facebook.com" class="color-facebook text-decoration-none"><i class="fab fa-facebook-square"></i> Facebook</a></div>
                                <div><a href="https://twitter.com" class="color-twitter text-decoration-none"><i class="fab fa-twitter"></i> Twitter</a></div>
                                <div><a href="https://www.instagram.com" class="color-instagram text-decoration-none"><i class="fab fa-instagram"></i> Instagram</a></div>
    ...
    <div class="uk-section uk-section-secondary uk-padding-remove-vertical">
        <div class="uk-container">
            <div class="uk-grid">
                ...
                <div class="uk-width-expand@m">
                    <p class="copyright-text">Copyright 2015-2024 © Aone Trades All Right Reserved</p>
                </div>
            </div>
        </div>
    </div>
