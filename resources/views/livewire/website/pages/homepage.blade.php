                ...
                <div class="owl-carousel">
                    <div class="item">
                        <div class="uk-card uk-card-default uk-card-body uk-box-shadow-large">
                            <p class="uk-text-small uk-text-uppercase">For Beginner<span class="uk-label in-label-small uk-margin-small-left" style="font-size:18px !important;">$ 200</span></p>
                            <h3 class="uk-margin-top uk-margin-remove-bottom">Startup Account
                            </h3>
                    ...
                    <div class="item">
                        <div class="uk-card uk-card-default uk-card-body uk-box-shadow-large">
                            <p class="uk-text-small uk-text-uppercase">For Intermediate<span class="uk-label in-label-small uk-margin-small-left" style="font-size:18px !important;">$ 1000</span></p>
                            <h3 class="uk-margin-top uk-margin-remove-bottom">Advance Account</h3>
                    ...
                    <div class="item">
                        <div class="uk-card uk-card-default uk-card-body uk-box-shadow-large">
                            <p class="uk-text-small uk-text-uppercase">For Expert<span class="uk-label in-label-small uk-margin-small-left" style="font-size:18px !important;">$ 5000</span></p>
                            <h3 class="uk-margin-top uk-margin-remove-bottom">Advance Account</h3>
                    ...
                    <div class="item">
                        <div class="uk-card uk-card-default uk-card-body uk-box-shadow-large">
                            <p class="uk-text-small uk-text-uppercase">For Master<span class="uk-label in-label-small uk-margin-small-left" style="font-size:18px !important;">$ 10000</span></p>
                            <h3 class="uk-margin-top uk-margin-remove-bottom">Expert Account</h3>
                    ...
                    <div class="item">
                        <div class="uk-card uk-card-default uk-card-body uk-box-shadow-large">
                            <p class="uk-text-small uk-text-uppercase">For Master<span class="uk-label in-label-small uk-margin-small-left" style="font-size:18px !important;">$ 10000</span></p>
                            <h3 class="uk-margin-top uk-margin-remove-bottom">VIP Account</h3>
