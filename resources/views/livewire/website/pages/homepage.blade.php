            ...
            <ul class="uk-slideshow-items uk-light">
                <li>
                    <div class="uk-position-cover">
                        <img src="img/in-slideshow-image-1.jpg" alt="slideshow-image" data-uk-cover width="1920" height="700" data-uk-img>
                    </div>
                    <span></span>
                ...
                <li>
                    <div class="uk-position-cover">
                        <img src="img/in-slideshow-image-2.jpg" data-src="img/in-slideshow-image-2.jpg" alt="slideshow-image" data-uk-cover width="1920" height="700" data-uk-img>
                    </div>
                    <span></span>
                    <div class="uk-container">
                        <div class="uk-grid" data-uk-grid>
        ...
        <div class="uk-container">
            <div class="uk-grid uk-grid-divider uk-child-width-1-2@s uk-child-width-1-4@m in-margin-top@s in-margin-bottom@s" data-uk-grid>
                <div>
                    <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                        <div class="uk-width-auto">
                            <img src="img/in-lazy.gif" data-src="img/in-wave-icon-1.svg" alt="Aone Trades" width="48" height="48" data-uk-img>
                        </div>
                ...
                <div>
                    <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                        <div class="uk-width-auto">
                            <img src="img/in-lazy.gif" data-src="img/in-wave-icon-2.svg" alt="Aone Trades" width="48" height="48" data-uk-img>
                        </div>
                        <div class="uk-width-expand">
                ...
                <div>
                    <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                        <div class="uk-width-auto">
                            <img src="img/in-lazy.gif" data-src="img/in-wave-icon-3.svg" alt="Aone Trades" width="48" height="48" data-uk-img>
                        </div>
                        <div class="uk-width-expand">
                            <p>Low minimum<br>deposit of $200</p>
                        </div>
                    </div>
                </div>
                <div>
                    <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                        <div class="uk-width-auto">
                            <img src="img/in-lazy.gif" data-src="img/in-wave-icon-4.svg" alt="Aone Trades" width="48" height="48" data-uk-img>
                        </div>
                        <div class="uk-width-expand">
            ...
            <div class="uk-grid uk-flex uk-flex-center">
                <div class="uk-width-3-5@m">
                    <div class="uk-card uk-card-default uk-card-body uk-text-center uk-border-rounded uk-box-shadow-small in-wave-2-card">
                        ...
                        Start with Aone Trades <a href="#">Join now!</a>
                    </div>
        ...
        <div class="uk-container">
            <div class="uk-grid-large uk-flex uk-flex-middle" data-uk-grid>
                <div class="uk-width-1-2@m">
                    <img class="uk-margin-bottom" src="img/in-lazy.gif" data-src="img/in-wave-icon-5.svg" alt="Aone Trades" width="64" height="64" data-uk-img>
                    <h1 class="uk-margin-remove">Market <span class="in-highlight">analysis</span> and<br>trade inspiration</h1>
                    <p>Pain itself is love, but to be held accountable is pain. Pleasure is something avoided by fault but desired by the soul, free of any guilt or fault.</p>
                    <div class="uk-grid-medium uk-child-width-1-2@s uk-child-width-1-3@m uk-text-center uk-margin-medium-top" data-uk-grid>
                        <div>
                            <div class="uk-card uk-card-default uk-card-body uk-border-rounded">
                                <img class="uk-margin-remove-bottom" src="img/in-lazy.gif" data-src="img/in-wave-icon-6.svg" alt="Aone Trades" width="52" height="52" data-uk-img>
                                <h5 class="uk-margin-small-top">Strategies & Discussions</h5>
                            </div>
                        </div>
                        <div>
                            <div class="uk-card uk-card-default uk-card-body uk-border-rounded">
                                <img class="uk-margin-remove-bottom" src="img/in-lazy.gif" data-src="img/in-wave-icon-7.svg" alt="Aone Trades" width="52" height="52" data-uk-img>
                ...
                <div class="uk-width-1-2@m">
                    <div class="uk-inline uk-dark in-wave-video uk-margin-small-bottom">
                        <img class="uk-border-rounded uk-width-1-1" src="img/in-lazy.gif" data-src="img/in-wave-image-1.jpg" alt="Aone Trades" width="533" height="355" data-uk-img>
                ...
                <div class="owl-carousel">
                    <div class="item">
                        <div class="uk-card uk-card-default uk-card-body uk-box-shadow-large">
                            <p class="uk-text-small uk-text-uppercase">For Beginner<span class="uk-label in-label-small uk-margin-small-left">$ 200</span></p>
                            <h2 class="uk-margin-top uk-margin-remove-bottom">Startup Account
                            </h2>

                            <hr>
                            <ul class="uk-list in-list-check">
                                <li>Base Currency Options: USD, EUR, GBP, JPY, CHF, AUD, HUF, PLN, SGD, ZAR</li>
                                <li>Leverage: Up to 400:1**</li>
                                <li>Spread: 2pips</li>
                                <li>Negative balance protection</li>
                                <li class="nobc"> No Commission</li>
                                <li>Hedging allowed: Yes</li>
                                <li>Trading Platform: Desktop, Android, IOS</li>
                                <li>Margin Call: 60%</li>
                                <li>Stop Out Level: 85%</li>
                                <li>Swap*</li>
                                <li>Islamic Account:Optional</li>
                                <li class="nobc"> Scalping Not Allowed </li>
                                <li>Training</li>
                            </ul>
                            <a href="sign-up.html" class="uk-button uk-button-primary uk-border-rounded uk-align-center">Open an account<i class="fas fa-chevron-circle-right fa-xs uk-margin-small-left"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="uk-card uk-card-default uk-card-body uk-box-shadow-large">
                            <p class="uk-text-small uk-text-uppercase">For Intermediate<span class="uk-label in-label-small uk-margin-small-left">$ 1000</span></p>
                            <h2 class="uk-margin-top uk-margin-remove-bottom">Advance Account</h2>

                            <hr>
                            <ul class="uk-list in-list-check">
                                <li>Base Currency Options: USD, EUR, GBP, JPY, CHF, AUD, HUF, PLN, SGD, ZAR</li>

                                <li>Withdrawable Bonus: Yes</li>
                                <li>Leverage: Up to 600:1**</li>
                                <li>Spread: 1.5pips</li>
                                <li>Negative balance protection</li>
                                <li class="nobc"> No Commission</li>
                                <li>Hedging allowed: Yes</li>
                                <li>Trading Platform: Desktop, Android, IOS</li>
                                ...
                                <li class="nobc"> Scalping Not Allowed </li>
                                <li>Training</li>
                                <li>Trading Central Indicator: Yes</li>
                            </ul>
                            <a href="sign-up.html" class="uk-button uk-button-primary uk-border-rounded uk-align-center">Open an account<i class="fas fa-chevron-circle-right fa-xs uk-margin-small-left"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="uk-card uk-card-default uk-card-body uk-box-shadow-large">
                            <p class="uk-text-small uk-text-uppercase">For Expert<span class="uk-label in-label-small uk-margin-small-left">$ 5000</span></p>
                            <h2 class="uk-margin-top uk-margin-remove-bottom">Advance Account</h2>
                            ...
                            <ul class="uk-list in-list-check">
                                ...
                                <li>Training</li>
                                <li>Trading Central Indicator: Yes</li>
                                <li>Expert Analysis: Yes</li>
                                <li>Personal Account Advisor Information about market trends, economic events, investing strategies and more.</li>
                            </ul>
                            <a href="sign-up.html" class="uk-button uk-button-primary uk-border-rounded uk-align-center">Open an account<i class="fas fa-chevron-circle-right fa-xs uk-margin-small-left"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="uk-card uk-card-default uk-card-body uk-box-shadow-large">
                            <p class="uk-text-small uk-text-uppercase">For Master<span class="uk-label in-label-small uk-margin-small-left">$ 10000</span></p>
                            <h2 class="uk-margin-top uk-margin-remove-bottom">Expert Account</h2>
                            ...
                            <ul class="uk-list in-list-check">
                                ...
                                <li>Expert Analysis: Yes</li>
                                <li>Personal Account Advisor Information about market trends, economic events, investing strategies and more.</li>
                                <li>News Updates: Yes</li>
                                <li>Daily Trades: Yes</li>
                            </ul>
                            <a href="#" class="uk-button uk-button-primary uk-border-rounded uk-align-center" tabindex="-1">Open an account<i class="fas fa-chevron-circle-right fa-xs uk-margin-small-left"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="uk-card uk-card-default uk-card-body uk-box-shadow-large">
                            <p class="uk-text-small uk-text-uppercase">For Master<span class="uk-label in-label-small uk-margin-small-left">$ 10000</span></p>
                            <h2 class="uk-margin-top uk-margin-remove-bottom">VIP Account</h2>
                            ...
                            <ul class="uk-list in-list-check">
                                ...
                                <li>Withdrawable Bonus: Yes</li>
                                <li>Leverage: Up to 1000:1**</li>
                                <li>Spread: 0.3pips</li>
                                <li>Negative balance protection</li>
                                <li class="nobc"> No Commission</li>
                                <li>Hedging allowed: Yes</li>
                                <li>Trading Platform: Desktop, Android, IOS</li>
...
<div uk-slider="autoplay: true; autoplayInterval: 3000">
							<div class="uk-slider-items uk-child-width-1-3">

								<div>
									<div class="uk-grid-collapse in-wave-pricing" data-uk-grid>
                ...
                <!-- <div class="uk-width-3-4@m">
					...
					<div class="uk-width-1-1">
						<div class="uk-grid-medium uk-child-width-1-2@s uk-child-width-1-5@m uk-text-center uk-margin-large-top" data-uk-grid>
							<div>
								<img src="img/in-lazy.gif" data-src="img/in-wave-award.svg" alt="Aone Trades" width="71" height="58" data-uk-img>
    ...
    <div class="uk-section uk-section-default uk-padding-remove-vertical in-wave-5 in-offset-bottom-30">
        <div class="uk-container">
            <div class="uk-grid">
                <div class="uk-width-1-1 uk-background-contain uk-background-center-right uk-background-image@s" style="background-image: url(img/in-wave-mockup-1.png);">
                    <h1 class="uk-margin-remove-bottom">Start <span class="uk-text-primary">trading</span></h1>
                    <p class="uk-text-lead">on <span class="uk-text-primary">Aone Trades</span> </p>
