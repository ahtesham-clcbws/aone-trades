                                                            ...
                                                            <td class="pad" style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:20px">
                                                                <div style="font-family:sans-serif">
                                                                    <div class style="font-size:12px;font-family:Arial,Helvetica Neue,Helvetica,sans-serif;mso-line-height-alt:14.399999999999999px;color:#fff;line-height:1.2">
                                                                        <p style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px"><span style="word-break: break-word; font-size: 30px;"><strong>Your account has been created!</strong></span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="text_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace:0;mso-table-rspace:0;word-break:break-word">
                                                        <tr>
                                                            <td class="pad" style="padding-bottom:10px;padding-left:20px;padding-right:20px;padding-top:10px">
                                                                <div style="font-family:sans-serif">
                                                                    <div class style="font-size:12px;font-family:Arial,Helvetica Neue,Helvetica,sans-serif;mso-line-height-alt:18px;color:#d8ebf8;line-height:1.5">
                                                                        <p
                                                                            style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:24px"><span style="word-break: break-word; font-size: 16px;">You can Login using the link below.</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <div style="font-family:sans-serif">
                                                                    <div class style="font-size:12px;font-family:Arial,Helvetica Neue,Helvetica,sans-serif;mso-line-height-alt:14.399999999999999px;color:#555;line-height:1.2">
                                                                        <p style="margin:0;font-size:14px;text-align:left;mso-line-height-alt:16.8px">
                                                                            <strong><span style="word-break: break-word; font-size: 24px;">Hello, <?= $user->name ?></span></strong>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="pad" style="padding-bottom:10px;padding-left:30px;padding-right:30px;padding-top:10px">
                                                                <div style="font-family:sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p style="margin:0;font-size:14px;text-align:left;mso-line-height-alt:21px">We are happy to inform you that your account has been created.</p>
                                                                        <p style="margin:0;font-size:14px;text-align:left;mso-line-height-alt:21px">You can use button above to log in.</p>
                                                                        <p style="margin:0;font-size:14px;text-align:left;mso-line-height-alt:18px">&nbsp;</p>
                                                                        <p
                                                                            style="margin:0;font-size:14px;text-align:left;mso-line-height-alt:21px">Use credentials below:</p>
                                                                        <p style="margin:0;font-size:14px;text-align:left;mso-line-height-alt:21px"><strong>EMAIL:</strong> <?= $user->email ?></p>
                                                                        <p style="margin:0;font-size:14px;text-align:left;mso-line-height-alt:21px"><strong>Password:</strong> user password, which you have created during the registration. In case if you don't remember the password, please use forget your password option.</p>
                                                                        <p
